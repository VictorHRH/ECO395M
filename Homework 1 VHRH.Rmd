...
ggplot(data = GasPrices) +
  geom_point(mapping = aes(x = Income, y = Price), color = blues9[7])
...
ggplot(df.out) +
  geom_point(mapping = aes(x = mileage, y = price), col = blues9[7]) +
  geom_line(mapping = aes(x = mileage, y = price_hat), 
            color = 'red', lwd = 2) +
  facet_wrap(~ trim)
```
